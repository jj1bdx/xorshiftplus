...
gcc -std=c99 -Wall murmurhash3.c -O3 -I/usr/local/include  -DTESTU01=bbattery_BigCrush -lprobdist -lmylib -ltestu01 -o murmurhash3-crush-full
gcc -std=c99 -Wall murmurhash3.c -O3 -I/usr/local/include  -DTESTU01=bbattery_BigCrush -DREVERSE -lprobdist -lmylib -ltestu01 -o murmurhash3-rev-crush-full

gcc -std=c99 -Wall -O3 murmurhash3.c -o murmurhash3-stdout
gcc -std=c99 -Wall -O3 murmurhash3.c -DREVERSE -o murmurhash3-rev-stdout

gcc -std=c99 -Wall -fomit-frame-pointer -msse4.2 xorshift64-speed.c -O3 -o xorshift64-speed
gcc -std=c99 -Wall -fomit-frame-pointer -msse4.2 xorshift64star32-speed.c -O3 -o xorshift64star32-speed
gcc -std=c99 -Wall -fomit-frame-pointer -msse4.2 xorshift128plus-speed.c -O3 -o xorshift128plus-speed
gcc -std=c99 -Wall -fomit-frame-pointer -msse4.2 xorshift128star8-speed.c -O3 -o xorshift128star8-speed
gcc -std=c99 -Wall -fomit-frame-pointer -msse4.2 xorshift1024star32-speed.c -O3 -o xorshift1024star32-speed
gcc -std=c99 -Wall -fomit-frame-pointer -msse4.2 xorshift1024-speed.c -O3 -o xorshift1024-speed
gcc -std=c99 -Wall -fomit-frame-pointer -msse4.2 xorshift1024plus-speed.c -O3 -o xorshift1024plus-speed
gcc -std=c99 -Wall -fomit-frame-pointer -msse4.2 xorshift4096star32-speed.c -O3 -o xorshift4096star32-speed
gcc -std=c99 -Wall -fomit-frame-pointer -msse4.2 xorshift1024-speed.c -O3 -o xorshift1024-speed
gcc -std=c99 -Wall -fomit-frame-pointer -msse4.2 xorshift4096-speed.c -O3 -o xorshift4096-speed
gcc -std=c99 -Wall -fomit-frame-pointer -msse4.2 xorgens4096-speed.c -O3 -o xorgens4096-speed
gcc -std=c99 -Wall -fomit-frame-pointer -msse4.2 well1024a-speed.c -O3 -o well1024a-speed
gcc -std=c99 -Wall -fomit-frame-pointer -msse4.2 well19937a-speed.c -O3 -o well19937a-speed
gcc -std=c99 -Wall -fomit-frame-pointer -msse4.2 mt19937-speed.c -O3 -o mt19937-speed
gcc -std=c99 -Wall -fomit-frame-pointer -msse4.2 murmurhash3-speed.c -O3 -o murmurhash3-speed
gcc -std=c99 -Wall -fomit-frame-pointer -msse4.2 ran-speed.c -O3 -o ran-speed
gcc -std=c99 -Wall -fomit-frame-pointer -msse4.2 xsadd-speed.c -O3 -o xsadd-speed
gcc -std=c99 -Wall -fomit-frame-pointer -msse4.2 jrand-speed.c -O3 -o jrand-speed

gcc -std=c99 -Wall -fomit-frame-pointer -msse4.2 loop-speed.c -O3 -o loop-speed
